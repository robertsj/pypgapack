...
/*
 * Note: a context wrapper class is added, a pointer to which
 *       is added to the Context contents.  This let's us fake
 *       a more class-based object oriented approach in C++ and
 *       Python pretty painlessly.
 */
...
//public:
//    PGABase()              : ctx( ) {}
//    PGABase(PGAContext *c) : ctx(c) {}
//    virtual ~PGABase() = 0;
//    PGAContext* GetContext(){return ctx;}
//    PGAContext* ctx;
//};
//PGABase::~PGABase(){}
/*****************************************
...
*****************************************/
//typedef class PGAContext PGAContext;
struct PGAContext {
    PGAAlgorithm           ga;
    PGACOperations         cops;
